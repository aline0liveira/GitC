...
namespace ConsoleBeep
{
    ...
    static class Tetris
    {
        ...
        static void Main()
        {
            ...
            var fileira = Console.ReadLine(); // Pega o numero digititado
            ...
            {
                // Atualizamos o valor da variavel "dataVerify" com a hora e minutos atuais
            ...
            switch (fileira)
            {
                // Case identifica que ele precisa fazer uma escolha logo em seguida ele pede o numero escolhido
                case "1": { Fileira1(startTimerIcrement); } break;// O break finaliza a operação
